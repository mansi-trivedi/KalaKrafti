        ...
        <div className="relative flex items-center justify-center overflow-hidden">
          <div className="absolute top-[40%] z-20 lg:top-[32%] md:top-[42%]">
            ...
            >
              ...
              <path
                d="M138.452,16.927c-91.485,32.577-142,71.991-138.258,93.967c3.344,19.643,32.592,9.367,47.592,17.033
      ...
      S206.786-7.406,138.452,16.927z"
          ...
          <div className="absolute z-0 top-[48%] left-[18%] md:top-[48%] md:left-[35%] lg:top-[43%] lg:left-[39%]">
            ...
            >
              ...
              <path
                d="M146.926,4.879C123.869,9.342,80.848,4.786,52.96,18.633C22.926,33.546,2.585,67.62,0.259,100.879
