    ...
    return (
        <header id="home" className="p-5 flex items-center justify-between border-gray-200 relative 
            ...
            <div className="container mx-auto max-w-none flex items-center flex-wrap justify-between gap-5">
                {/* Logo */}
                <div className="text-lg font-bold text-brick cursor-pointer">Brand Logo</div>
                ...
                <div className="flex space-x-4 text-brick">
                    ...
                    <Link href="/login" className="p-0.5 transition-transform duration-500 hover:rotate-y-180">
                        <FiUser size={20} className="hover:fill-brick" />
                    </Link>

                    <Link href="/wishlist" className="p-0.5 transition-transform duration-500 hover:rotate-y-180">
                        <FiHeart size={20} className="hover:fill-brick" />
                    </Link>

                    <Link href="/cart" className="p-0.5 transition-transform duration-500 hover:rotate-y-180">
